...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful sales calculator tool, check it out: https://seosaurus.in/tools/sales-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/sales-calculator/";
